...
//               wall to them.                                                  //
//////////////////////////////////////////////////////////////////////////////////
  void look(ArrayList<Tile> walls) {
    for (int i = 0; i < this.rays.size(); i++) {                                // For loop over all the rays
      ...
      for (Tile w : walls) {                                                    // Loop through all the walls in the wall array
        PVector pt = null;// = r.cast(w);                                                 // Get the point of where the ray hits the current wall
